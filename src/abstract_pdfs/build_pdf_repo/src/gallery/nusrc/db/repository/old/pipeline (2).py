...
from abstract_database import get_db_vars
...
PDFS_ROOT = os.environ.get("PDFS_ROOT", "/data/pdfs")
...
def run_pipeline() -> None:
    ...
    dbUrl = dbVars.get('dburl')
    conn = psycopg.connect(conninfo=dbUrl, autocommit=True)
    try:
